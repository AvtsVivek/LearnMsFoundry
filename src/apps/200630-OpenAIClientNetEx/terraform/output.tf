...
output "azure_openai_v1_endpoint" {
  description = "The OpenAI v1 compatible endpoint for Azure OpenAI."
  value       = "https://${azurerm_cognitive_account.foundry_resource.custom_subdomain_name}.openai.azure.com/openai/v1"
}