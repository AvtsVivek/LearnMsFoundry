...
cd src/tasks/200640-AnthropicClientNetEx

cd src/apps/200640-AnthropicClientNetEx/terraform
...
pwsh ../AnthropicAiEndpointCopyToClipboard.ps1
...
cd ../AnthropicClientNetEx

dotnet run AnthropicClientNetEx.ConsoleApp.csproj
