...
cd src/tasks/200630-OpenAIClientNetEx

cd src/apps/200630-OpenAIClientNetEx/terraform
...
cd ../OpenAIClientNetConsoleApp

dotnet run OpenAIClientNetEx.ConsoleApp.csproj
